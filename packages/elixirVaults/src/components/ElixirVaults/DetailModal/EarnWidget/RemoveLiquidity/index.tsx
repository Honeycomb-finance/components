...
import { Box, Button, Loader, NumberOptions, Text, TextInput } from '@honeycomb-finance/core';
import {
  MixPanelEvents,
  getEtherscanLink,
  useChainId,
...
import { useElixirVaultActionHandlers, useVaultActionHandlers } from 'src/hooks';
import { ElixirVault, RemoveElixirVaultLiquidityProps } from 'src/hooks/types';
