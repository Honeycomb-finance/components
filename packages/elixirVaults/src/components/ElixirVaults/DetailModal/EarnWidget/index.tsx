...
import { PNG, useChainId, useLibrary, usePangolinWeb3, useTranslation } from '@honeycomb-finance/shared';
...
const EarnWidget: React.FC<EarnWidgetProps> = (props) => {
  ...
  const [isRemoveDrawerVisible, setShowRemoveDrawer] = useState(true); // TODO:
